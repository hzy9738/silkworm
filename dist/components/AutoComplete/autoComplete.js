...
export var AutoComplete = function (props) {
    ...
    var generateDropdown = function () {
        return (_jsxs("ul", __assign({ className: 'zongone-suggestion-list' }, { children: [loading &&
    ...
    return (_jsxs("div", __assign({ className: 'zongone-auto-complete', ref: componentRef }, { children: [_jsx(Input, __assign({ value: inputValue, onChange: handleChange, onKeyDown: handleKeyDown }, restProps)), generateDropdown()] })));
};
